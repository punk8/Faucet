...
import { RateLimiter, VerifyCaptcha, VerifyTwitter, parseBody, parseURI } from './middlewares'
...
app.use(express.static(path.join(project_path, "client/public")))
app.use(cors())
app.use(parseURI)
app.use(parseBody)
...
app.get('*', async (req: any, res: any) => {
    res.sendFile(path.join(project_path, "client/public", "index.html"))
})
