...
const FaucetForm = (props: any) => {
    ...
    useEffect(() => {
        if (address && isFaucetTwitterLink(twitterLink)) {
    ...
    function calculateLargestUnit(amount: string = "0", decimals: number = 18): string {
        ...
        return (Number(amount) / Number(base)).toString()
    }
    ...
    function updateTwitterLink(twitterLink: any): void {
                ...
                <div className='box-content'>
                    ...
                    <div style={{ display: sendTokenResponse?.txHash ? "none" : "block" }}>
                        ...
                        <div className="twitter-link">
                            <input
                                placeholder='Paste your twitter share link into here...'
                                value={twitterLink || ""}
